def except_for_string(string):
    ...
    # TODO, пожалуйста, обратите внимание, внутри этой функции, ловить ошибки не нужно, только вызывать.
    #  Ловить и записывать в файл стоит только в основном цикле программы.
